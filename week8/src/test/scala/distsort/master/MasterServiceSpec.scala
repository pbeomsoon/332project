...
class MasterServiceSpec extends AnyFlatSpec with Matchers with BeforeAndAfterEach {
  ...
  "MasterService" should "handle worker registration correctly" in {
    val service = new MasterService(expectedWorkers = 3, initialNumPartitions = 9)
  ...
  it should "allow worker re-registration" in {
    val service = new MasterService(expectedWorkers = 2, initialNumPartitions = 4)
  ...
  it should "reject registration when max workers reached" in {
    val service = new MasterService(expectedWorkers = 1, initialNumPartitions = 3)
  ...
  it should "compute correct number of partition boundaries" in {
    val service = new MasterService(expectedWorkers = 2, initialNumPartitions = 6)
  ...
  it should "handle concurrent worker registrations" in {
    val service = new MasterService(expectedWorkers = 10, initialNumPartitions = 30)
  ...
  "MasterService.createShuffleMap" should "create 1:1 mapping for Strategy A" in {
    val service = new MasterService(expectedWorkers = 3, initialNumPartitions = 3)
  ...
  it should "handle uneven partition distribution" in {
    val service = new MasterService(expectedWorkers = 3, initialNumPartitions = 10)
  ...
  it should "handle single worker case" in {
    val service = new MasterService(expectedWorkers = 1, initialNumPartitions = 5)
  ...
  it should "assign all partitions to workers via shuffleMap" in {
    val service = new MasterService(expectedWorkers = 4, initialNumPartitions = 12)
